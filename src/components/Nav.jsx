            ...
            <nav className={`row ${styles.navContainer}`} id='nav'>
                ...
                <div className={`col-lg-9 col-md-9 col-sm-6 ${styles.navLinks}`}>
                    <ul>
                        ...
                        <li><a href="https://www.linkedin.com/in/bilguun-zorigtbaatar" id="linkLinkedIn" target="_blank">LinkedIn</a></li>
                        <li><a href="https://github.com/Bilguun-Zorig" id="linkGithub" target="_blank">Github</a></li>
                    </ul>
                </div>
